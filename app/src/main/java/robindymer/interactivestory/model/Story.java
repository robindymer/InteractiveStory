...
public class Story {
    // A private array of pages called pages
    private Page[] pages;

    public Story() {
        // New array of pages of size 7 because we have 7 pages
        pages = new Page[7];

        // Create our first page with the Page class. The second parameter in choice is the next page
    ...
    public Page getPage(int pageNumber) {
        // Make sure we don't ask for a page that is out of bounds
